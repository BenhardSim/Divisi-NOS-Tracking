...
class siteprofileFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'TOWERSTATUS' => $this->faker->randomElement(['Sewa TP', 'Sewa Other', 'Beli']),
            'PEMILIKLAHAN' => $this->faker->name(),
            'PEMILIKTOWER' => $this->faker->randomElement(['Alfamart', 'Indomaret', 'Mixue', 'Naskun Pasundan', 'Burjoni Sipodang', 'Warteg Putri Bahari', 'Oti', 'BP', 'Warung Makan Gondang Raya']),
